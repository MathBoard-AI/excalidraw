import { KEYS, arrayToMap } from "@mathboard-ai/common";

import { pointFrom } from "@mathboard-ai/math";

import { actionWrapTextInContainer } from "@mathboard-ai/excalidraw/actions/actionBoundText";

import { Excalidraw, isLinearElement } from "@mathboard-ai/excalidraw";

import { API } from "@mathboard-ai/excalidraw/tests/helpers/api";
import { UI, Pointer, Keyboard } from "@mathboard-ai/excalidraw/tests/helpers/ui";
import { fireEvent, render } from "@mathboard-ai/excalidraw/tests/test-utils";
